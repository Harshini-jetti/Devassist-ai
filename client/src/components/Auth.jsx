      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 bg-white text-gray-800 font-medium px-4 py-2.5 rounded-lg text-sm hover:bg-gray-100 active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer mb-5"
          >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-[var(--color-text-dim)] font-mono">or</span>
            <div className="flex-1 h-px bg-[var(--color-border)]" />
          </div>
